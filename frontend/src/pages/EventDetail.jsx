  ...
  return (
    <>
      <Card className="my-4 sm:my-8 max-w-2xl mx-auto p-4 sm:p-6 shadow-lg">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-gray-800">{event.name}</h2>

        <div className="bg-gray-50 rounded-lg p-3 sm:p-4 mb-6 border">
          <ul className="grid grid-cols-1 gap-3 sm:gap-4 text-gray-700 text-sm">
            <li>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-2 sm:gap-4">
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 flex-1">
            ...
            <Button color="green" onClick={() => navigate(`/events/${id}/edit`)} className="w-full sm:w-auto">
              Edit Event
            </Button>
          </div>
